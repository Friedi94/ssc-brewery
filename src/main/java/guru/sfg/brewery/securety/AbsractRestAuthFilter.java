...
@Slf4j
public abstract class AbsractRestAuthFilter extends AbstractAuthenticationProcessingFilter {
    public AbsractRestAuthFilter(RequestMatcher requiresAuthenticationRequestMatcher) {
